package flu::daily::PAN155GeneDailyConfig;
use strict;
use Exporter;
...
%configParams = (
  ...
  schemaOwner  => 'dots',
  ###
  ### PA-N155 Gene Parameters
  ###
  className    => 'Genes::Single',
  datasetName  => 'pa-n155',
  discardFile  => 'workspaceRoot/pa-n155_discard.dat',
  generate     => 1,
  load         => 1,
  useDelta     => 0,
